<div class="container">
    <div class="margin-top" ng-controller="TabController as tab">
        ...
        <div class="slot-game-buttons container-box box-main box-default margin-bottom">
            <div class="slot-game-button slot-game-button1" ng-class="{ active:tab.isSet(1) }" ng-click="tab.setTab(1)">
                <h3>Microgaming</h3>
                <button class="btn btn-play hvr-push">Play Now</button>
                <div class="slot-game-button-overlay"></div>
            </div>
            <div class="slot-game-button slot-game-button2" ng-class="{ active:tab.isSet(2) }" ng-click="tab.setTab(2)">
                <h3>Gameplay</h3>
                <button class="btn btn-play hvr-push">Play Now</button>
                <div class="slot-game-button-overlay"></div>
            </div>
            <div class="slot-game-button slot-game-button3" ng-class="{ active:tab.isSet(3) }" ng-click="tab.setTab(3)">
                <h3>Betsoft</h3>
                <button class="btn btn-play hvr-push">Play Now</button>
                <div class="slot-game-button-overlay"></div>
            </div>
            <div class="slot-game-button slot-game-button4" ng-class="{ active:tab.isSet(4) }" ng-click="tab.setTab(4)">
                <h3>Xin Slot</h3>
                <button class="btn btn-play hvr-push">Play Now</button>
                <div class="slot-game-button-overlay"></div>
            </div>
            <div class="slot-game-button slot-game-button5 no-border" ng-class="{ active:tab.isSet(5) }" ng-click="tab.setTab(5)">
                <h3>Laxino</h3>
                <button class="btn btn-play hvr-push">Play Now</button>
                <div class="slot-game-button-overlay"></div>
            </div>
